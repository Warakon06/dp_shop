  		...
  		<div class="content-wrapper">
    		...
    		<div class="content-header">
      			<div class="container-fluid">
        			<div class="row mb-2">
          				<div class="col-sm-6">
            				<h1 class="m-0">รายงานสมาชิก</h1>
          				</div>
          				<!-- /.col -->
	          			<div class="col-sm-6">
	            			<ol class="breadcrumb float-sm-right">
	              				<li class="breadcrumb-item"><a href="dashboard.php">แดชบอร์ด</a></li>
	              				<li class="breadcrumb-item active">รายงานสมาชิก</li>
	            			</ol>
	          			</div>
	          			<!-- /.col -->
        			</div>
    		...
    		<section class="content">
      			<div class="container-fluid">
                    <form action="report_member.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="name">ป้อนชื่อหรือนามสกุลสมาชิก</label>
                            ...
                            <div class="card">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        ';
                                        if (!empty($_POST['name'])) {
                                            $query .= ' where first_name like "%'.$_POST['name'].'%" ';
                                        }
