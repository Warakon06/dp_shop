  		...
  		<div class="content-wrapper">
    		...
    		<div class="content-header">
      			<div class="container-fluid">
        			<div class="row mb-2">
          				<div class="col-sm-6">
            				<h1 class="m-0">รายการขอคืนสินค้า</h1>
          				</div>
          				<!-- /.col -->
	          			<div class="col-sm-6">
	            			<ol class="breadcrumb float-sm-right">
	              				<li class="breadcrumb-item"><a href="dashboard.php">แดชบอร์ด</a></li>
	              				<li class="breadcrumb-item active">รายการขอคืนสินค้า</li>
	            			</ol>
	          			</div>
	          			<!-- /.col -->
        			</div>
                                            ...
                                            <table id="example1" class="table table-bordered table-hover table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center; font-weight: bold;">สาเหตุการขอคืน</th>
                                                ...
                                                <tbody>
                                                    <?php 
                                                        $query = 'select 
                                                            ...
                                                            b.phone_number, a.return_orders_reason, a.shop_comment 
                                                            from orders as a 
                                                            left outer join member as b on a.member_id = b.member_id 
                                                            where a.return_orders_reason is not null
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $rs['return_orders_reason']; ?></td> 
                                                        <td><?php echo $rs['shop_comment']; ?></td>
                                                        <td>
                                                            <?php 
                                                                if (!empty($rs['return_orders_reason']) 
                                                                    and $rs['status']!=7 
                                                                    and $rs['status']!=8) {
                                                                    echo 'ขอคืนสินค้า';
                                                                } else {
                                                        ...
                                                        <td>
                                                            <?php if (!empty($rs['return_orders_reason']) 
                                                                and $rs['status']!=7 
                                                                and $rs['status']!=8) { ?>
                                                            <div class="btn-group">
                                                                <a href="#" onclick="editRet('<?php echo $rs['orders_id']; ?>')" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                                            </div>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
...
<script>
    ...
    function editRet(orders_id) {
        let data = new Object();
        data.orid = orders_id;

        $('#return-modal').load('edit_return_orders_modal.php', data, function(){
            $("#edit-return").modal('show');
        });
    }
