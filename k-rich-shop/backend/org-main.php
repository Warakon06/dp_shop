      						...
      						<div class="card card-primary card-outline">
              					<div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <a href="#" class="btn btn-success"><i class="fas fa-plus-circle"></i> เพิ่มข้อมูล</a>
                                            ...
                                            <table id="example1" class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="#" class="btn btn-warning"><i class="fas fa-search"></i> รายละเอียด</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>5.5</td>
                                                        <td>
                                                            <a href="#" onclick="myModal()" class="btn btn-warning"> Launch Modal</a>
                                                            <!-- <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-xl">Launch Modal</button> -->
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Trident</td>
...
<script>
    ...
    function myModal() {
        ...
        $('#my-modal').load('modal.php', data, function(){
            $("#my-detail").modal('show');
        });
    }
