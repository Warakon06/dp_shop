  		...
  		<div class="content-wrapper">
    		...
    		<div class="content-header">
      			<div class="container-fluid">
        			<div class="row mb-2">
          				<div class="col-sm-6">
            				<h1 class="m-0">หมวดหมู่สินค้า</h1>
          				</div>
          				<!-- /.col -->
	          			<div class="col-sm-6">
      						...
      						<div class="card card-primary card-outline">
              					<div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <a href="#" onclick="addCat()" class="btn btn-success"><i class="fas fa-plus-circle"></i> เพิ่ม</a>
                                    </div>
              					</div>
              					<div class="card-body">
	                				<div class="row">
                                            ...
                                            <table id="example1" class="table table-bordered table-hover table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center; font-weight: bold;">หมวดหมู่สินค้า</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="#" onclick="editCat('<?php echo $val['category_id']; ?>')" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                                                <a href="#" onclick="confirmDelete('<?php echo $val['category_id']; ?>')" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <?php } } ?>
...
<script>
    ...
    function addCat() {
        ...
        $('#cat-modal').load('add_category_modal.php', data, function(){
            $("#add-cat").modal('show');
        });
    }
    ...
    function editCat(category_id) {
        ...
        $('#cat-modal').load('edit_category_modal.php', data, function(){
            $("#edit-cat").modal('show');
        });
    }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    data : {id_del:category_id},
                    success: function(response){
                        //console.log(response);
                        if (response=='true') {
                            top.window.location='category.php?act=del_success';
                        } else {
                            top.window.location='category.php?act=del_error';
                        }
                    }
                });
            }
