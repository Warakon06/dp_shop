...
<div id="edit-delivery" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
  	<div class="modal-dialog modal-xl" style="width: 100%;">
      	<div class="modal-content">
          	<div class="modal-header bg-header-modals">
              	<h4 class="modal-title " id="myModalLabel2">แก้ไขการจัดส่งสินค้า</h4>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ddate" id="ddate" value="<?php echo thaidate($rs['delivery_date']); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="dtime">เวลาจัดส่ง</label>
                            <input type="text" class="form-control" name="dtime" value="<?php echo $rs['delivery_time']; ?>" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="traking" value="<?php echo $rs['delivery_track']; ?>" required>
                        </div>
                    </div>
                </div>
          	</div>
